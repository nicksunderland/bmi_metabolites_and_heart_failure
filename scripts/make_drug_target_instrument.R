...
gene_win_kb<- as.integer(snakemake@params[["gene_win_kb"]])
...
# from start of gene (TSS) see PMID: 35527238
gene_win <- gene_win_kb * 1000
raw_gwas    <- raw_gwas[get(raw_chr_col) == gene_chr & get(raw_bp_col) > gene_start - gene_win & get(raw_bp_col) < gene_start + gene_win]
